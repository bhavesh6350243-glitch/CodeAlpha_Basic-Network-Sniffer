#!/usr/bin/env python3
"""
Network Sniffer Web Application
Flask-based web interface for real-time network packet monitoring.
"""
...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'network_sniffer_secret_key'
...
def export_packets():
    ...
    data = request.get_json()
    filename = data.get('filename', f'packets_{datetime.now().strftime("%Y%m%d_%H%M%S")}.json')
...
if __name__ == '__main__':
    ...
    print("Network Sniffer Web Application")
